...
* Kein PDF mit matplotlib erzeugen, sondern nur die pgf Datei
* im TeXmanager (bei mir in C:\Python311\Lib\site-packages\matplotlib im template siunitx dazuladen)
* im PGF Backend (bei mir in C:\Python311\Lib\site-packages\matplotlib\backends\backend_pgf.py) das \sffamily durch einen Leerstring ersetzen
"""
...
plt.savefig('uwe2.pgf', backend='pgf')
#plt.show()
